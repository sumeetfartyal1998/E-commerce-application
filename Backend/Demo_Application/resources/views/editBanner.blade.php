...
@include('includes.sidebar')
    ...
    <main class="content-wrapper">
        ...
        <section class="content">
            <form class="container-fluid" method="post" enctype="multipart/form-data" action="{{asset('/editbanner')}}">
                @csrf()
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Enter banner details</h3>
                        ...
                        <div class="">
                            <div class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id="exampleFormControlFile1" name="img" value="{{$banner['img']}}">
                                </div>
                                @if($errors->has('img'))
